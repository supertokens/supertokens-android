...
// TODO: These are commented because we could not mock cookie handling correctly, when we do header based sessions we will fix these tests
...
//
//        MockedStatic<HttpCookie> mockedHttpCookie = Mockito.mockStatic(HttpCookie.class);
//
//
//        HttpCookie mockCookie = Mockito.mock(HttpCookie.class);
...
//        Mockito.when(mockCookie.isHttpOnly()).thenAnswer(invocation -> {
//            return false;
//        });
...
//        SuperTokens.init(context, Constants.apiDomain);
//        CookieManager.setDefault(new CookieManager(new SuperTokensPersistentCookieStore(context), CookiePolicy.ACCEPT_ALL));
//
//        //do a login request
